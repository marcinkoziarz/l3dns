...
public class ByteArrayDataInputStream implements DataInput {
	...
	public ByteArrayDataInputStream(byte[] data, int offset, int length) {
		this.data=data;
		this.offset=offset;
		this.length=length;
	...
	@Override
	public ByteArrayDataInputStream clone() {
		ByteArrayDataInputStream newbadis = new ByteArrayDataInputStream(data, offset, length);
		newbadis.position=position;
		return newbadis;
	}
	...
	public static String readUTF(DataInput in) throws IOException {
		...
		ByteArrayDataInputStream dis = (ByteArrayDataInputStream)in;
